...
## 📚 Overview
TalentFlow is a recruitment and learning management platform built with **ASP.NET Core**, designed around **Domain‑Driven Design (DDD)** and 
**Event‑Driven Architecture (EDA)**. It streamlines hiring and course management with:
