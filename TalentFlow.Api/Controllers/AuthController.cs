...
namespace TalentFlow.Api.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromForm] RegisterUserRequest request)
        {
            ...
            // File processing (same as you have)
            ...
            if (userDto == null)
            {
                ...
                // If handler returns null because of duplicate email or DB conflict, return Conflict
                // Optionally, the handler can throw a DuplicateEmailException to be mapped by middleware.
                return Conflict(ApiResponse.Fail<string>("Email already registered", 409));
            }
            ...
            return CreatedAtAction(nameof(Register), ApiResponse.Success<object>(responsePayload, "User registered successfully. OTP sent to your email.", 201));
        }
