...
namespace TalentFlow.Infrastructure.Storage
{
    public class LocalFileStorageService : IFileStorageService
    {
        ...
        public Task<bool> DeleteFileAsync(string fileUrl)
        {
            ...
            var baseUrlTrim = _options.BaseUrl.TrimEnd('/');
            var relative = fileUrl.StartsWith(baseUrlTrim, StringComparison.OrdinalIgnoreCase)
                ? fileUrl.Substring(baseUrlTrim.Length).TrimStart('/')
                : fileUrl.TrimStart('/');
